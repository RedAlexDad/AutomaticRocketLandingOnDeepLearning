...
class TerrainGenerator(QWidget):
    ...
    def generate_terrain(self):
        ...
        for i in range(self.num_points):
            ...
            y = int(self.get_terrain_height(x))
...
class CoordinateGrid(QWidget):
    def __init__(self, parent=None):
        ...
        # Флаг для изменения направления оси Y
    ...
    def paintEvent(self, event):
        ...
        # Надпись по оси X
        painter.drawText(self.width() - 20, self.height() - 5, "X")

        # Надпись по оси Y
        if not self.invert_y_axis:
            painter.drawText(self.width() - 20, 15, "Y")
        else:
            painter.drawText(self.width() - 20, self.height() - 5, "Y")
    ...
    def invertYAxis(self, invert):
        # Метод для инвертирования направления оси Y
        self.invert_y_axis = invert
        self.update()
