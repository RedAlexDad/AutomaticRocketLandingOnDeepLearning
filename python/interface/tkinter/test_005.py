...
class RocketLanderApp:
    def __init__(self, master, terrain_size, roughness):
        ...
        rocket_start_x = 0
        # Положение ракеты по центру поверхности
        rocket_start_y = self.terrain[int(self.terrain_size / 2)] - 10
        self.rocket = self.canvas.create_oval(rocket_start_x, rocket_start_y, rocket_start_x + 20, rocket_start_y + 20, fill="red")
