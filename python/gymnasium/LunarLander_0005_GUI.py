...
class LunarLanderDQNAgent:
    ...
    def update_dataset(self, epoch, total_reward, actions, observations, next_observations, dones):
        self.dataset['epochs'].append(epoch)
        self.dataset['rewards'].append(total_reward)
    ...
    def train(self):
        ...
        for epoch in range(self.num_episodes):
            ...
            # Обновление датасета
            self.update_dataset(epoch, total_reward, actions, observations, next_observations, dones)
    ...
    def plot_rewards_realtime(self):
        ...
        epochs = []
        rewards = []
        line, = plt.plot(epochs, rewards, marker='o', linestyle='-')  # Инициализируем график
        plt.show()
...
if __name__ == "__main__":
    agent = LunarLanderDQNAgent(num_episodes=2)
